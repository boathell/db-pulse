...
- 当前关注范围保留 8 个核心数据库生态、26 条治理来源、36 个中英双语 Event、六条行业主线和四类决策角色。
- 按关注范围软退役 10 个数据库生态及 4 条政策、研究和资本来源；旧来源保留历史 provenance，不再进入当前观察目录。
- GreptimeDB 官方微信公众号作为 Tier 1 受限来源进入 shadow 目录；仅保存账号与文章元数据，不自动抓取微信正文或生成 Event。
- 庄晓丹“此间山林”公众号作为 Tier 3 受限专家来源进入 shadow 目录；完成创始人身份与机构关系核验，但不把个人号当作 Greptime 官方发布或独立佐证。
